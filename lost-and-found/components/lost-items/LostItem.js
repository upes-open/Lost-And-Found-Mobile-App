...
const LostItem = () => {
    ...
    return (
        <View style={styles.container}>
            ...
            <View >
                ...
                <View style={styles.inputContainer}>
                    ...
                    <TextInput
                        style={styles.input}
                        value={description}
                        onChangeText={(text) => { setDescription(text); checkFormValidity(); }}
                ...
                <View>
                    ...
                    <View style={styles.inputContainer}>
                        ...
                        <TextInput
                            style={styles.input}
                            value={itemName}
                            onChangeText={(text) => { setItemName(text); checkFormValidity(); }}
            ...
            <View>
                {itemImage ?
                    <Image source={{ uri: itemImage }} style={{ width: 150, height: 150, borderRadius: 5, padding: 20, margin: 20, }} />
                    :
                    <Text style={styles.textinput}> Upload Image </Text>
                }
                <TouchableOpacity style={styles.selectBtn} onPress={pickImage}>
                    <Text style={{ color: "white", fontFamily: "DMRegular" }}>Select Image</Text>
                </TouchableOpacity>
            </View>
